 ...
 * allowed auto-updating. <br> It is a <b>BUKKIT POLICY</b> that you include a boolean value in your
 * config that prevents the auto-updater from running <b>AT ALL</b>. <br> If you fail to include
 * this option in your config, your plugin will be <b>REJECTED</b> when you attempt to submit it to
 * dev.bukkit.org.
 * <p/>
 * An example of a good configuration option would be something similar to 'auto-update: true' - if
 * this value is set to false you may NOT run the auto-updater. <br> If you are unsure about these
 * rules, please read the plugin submission guidelines: http://goo.gl/8iU5l
 *
 * @author Gravity
 * @version 2.0
 */
...
public class Updater {
  ...
  private void saveFile(File folder, String file, String u) {
    ...
    try {
      ...
      this.plugin.getLogger()
          .warning("The auto-updater tried to download a new update, but was unsuccessful.");
  ...
  private boolean versionCheck(String title) {
    if (this.type != UpdateType.NO_VERSION_CHECK) {
      ...
      if (title.split(" v").length == 2) {
        ...
        this.plugin.getLogger().warning("The author of this plugin" + authorInfo
            + " has misconfigured their Auto Update system");
        this.plugin.getLogger()
            .warning("File versions should follow the format 'PluginName vVERSION'");
  ...
  private boolean read() {
    try {
      ...
      this.versionName = (String) ((JSONObject) array.get(array.size() - 1)).get(
          Updater.TITLE_VALUE);
      this.versionLink = (String) ((JSONObject) array.get(array.size() - 1)).get(
          Updater.LINK_VALUE);
      this.versionType = (String) ((JSONObject) array.get(array.size() - 1)).get(
          Updater.TYPE_VALUE);
      this.versionGameVersion = (String) ((JSONObject) array.get(array.size() - 1)).get(
          Updater.VERSION_VALUE);
  ...
  public enum UpdateResult {
    ...
    FAIL_DBO,
    /**
     * When running the version check, the file on DBO did not contain the a version in the format
     * 'vVersion' such as 'v1.0'.
     */
    FAIL_NOVERSION,
    /**
      ...
      if (Updater.this.url != null) {
        ...
        if (Updater.this.read()) {
          if (Updater.this.versionCheck(Updater.this.versionName)) {
            if ((Updater.this.versionLink != null) && (Updater.this.type
